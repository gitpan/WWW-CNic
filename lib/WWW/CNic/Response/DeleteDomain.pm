...
# $Id: DeleteDomain.pm,v 1.6 2011/05/13 13:31:49 gavin Exp $

package WWW::CNic::Response::DeleteDomain;
use vars qw($VERSION);
...
WWW::CNic::Response::DeleteDomain - a WWW::CNic response object for domain deletion.
...
Response module for domain deletion requests via the CentralNic Toolkit (http://toolkit.centralnic.com/). This module inherits all its methods from the base class, I<WWW::CNic::Response>.
