...
WWW::CNic::Response::SubmitPaymentBatch - a WWW::CNic response object for submitting payment advice.
...
Response module for submitting payment advice via the CentralNic Toolkit (http://toolkit.centralnic.com/). This module inherits all its methods from the base class, I<WWW::CNic::Response>.
