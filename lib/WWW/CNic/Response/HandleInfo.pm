...
# $Id: HandleInfo.pm,v 1.4 2010/03/31 11:58:31 gavin Exp $

package WWW::CNic::Response::HandleInfo;
use vars qw($VERSION);
...
WWW::CNic::Response::HandleInfo - a WWW::CNic response object for handle information requests.
...
Response module for handle information requests via the CentralNic Toolkit (http://toolkit.centralnic.com/). This module inherits all its methods from the base class, I<WWW::CNic::Response>.
