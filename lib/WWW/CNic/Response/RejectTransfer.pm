...
# $Id: RejectTransfer.pm,v 1.2 2010/03/31 11:58:31 gavin Exp $

package WWW::CNic::Response::RejectTransfer;
use vars qw($VERSION);
...
WWW::CNic::Response::RejectTransfer - a WWW::CNic response object for rejecting domain transfer requests.
...
Response module for rejecting a domain transfer via the CentralNic Toolkit (http://toolkit.centralnic.com/). This module inherits all its methods from the base class, I<WWW::CNic::Response>.
