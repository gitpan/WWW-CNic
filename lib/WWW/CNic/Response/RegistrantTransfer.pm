...
# $Id: RegistrantTransfer.pm,v 1.2 2011/05/13 13:31:49 gavin Exp $

package WWW::CNic::Response::RegistrantTransfer;
use vars qw($VERSION);
...
WWW::CNic::Response::RegistrantTransfer - a WWW::CNic response object for domain registrant transfer requests.
