...
# $Id: DeclineDomain.pm,v 1.6 2011/05/13 13:31:49 gavin Exp $

package WWW::CNic::Response::DeclineDomain;
use vars qw($VERSION);
...
WWW::CNic::Response::DeclineDomain - a WWW::CNic response object for declining renewal.
...
Response module for declining domain renewals via the CentralNic Toolkit (http://toolkit.centralnic.com/). This module inherits all its methods from the base class, I<WWW::CNic::Response>.
