...
# $Id: Modify.pm,v 1.11 2011/05/13 13:31:49 gavin Exp $

package WWW::CNic::Response::Modify;
use vars qw($VERSION);
...
WWW::CNic::Response::Modify - a WWW::CNic response object for domain modification.
...
Response module for domain modification requests via the CentralNic Toolkit (http://toolkit.centralnic.com/). This module inherits all its methods from the base class, I<WWW::CNic::Response>.
